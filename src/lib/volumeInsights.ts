...
const KEYWORD_MAP: Array<{ kw: string; credits: Array<[string, number]> }> = [
  ...
  { kw: 'close-grip bench',    credits: [['cat-triceps', 1.0], ['cat-chest', 0.25]] },
  { kw: 'incline press',       credits: [['cat-chest', 1.0], ['cat-shoulders', 0.2], ['cat-triceps', 0.15]] },
  { kw: 'bench press',         credits: [['cat-chest', 1.0], ['cat-triceps', 0.2], ['cat-shoulders', 0.1]] },
  { kw: 'chest press',         credits: [['cat-chest', 1.0], ['cat-triceps', 0.2], ['cat-shoulders', 0.1]] },
  { kw: 'shoulder press',      credits: [['cat-shoulders', 1.0], ['cat-triceps', 0.2]] },
  { kw: 'overhead press',      credits: [['cat-shoulders', 1.0], ['cat-triceps', 0.2]] },
  { kw: 'military press',      credits: [['cat-shoulders', 1.0], ['cat-triceps', 0.2]] },
  { kw: 'arnold press',        credits: [['cat-shoulders', 1.0], ['cat-triceps', 0.2]] },
  { kw: 'lateral raise',       credits: [['cat-shoulders', 1.0]] },
  { kw: 'front raise',         credits: [['cat-shoulders', 1.0]] },
  { kw: 'rear delt',           credits: [['cat-shoulders', 1.0], ['cat-back', 0.15]] },
  { kw: 'face pull',           credits: [['cat-shoulders', 0.8], ['cat-back', 0.2]] },
  { kw: 'upright row',         credits: [['cat-shoulders', 1.0], ['cat-back', 0.15]] },

  // Chest
  { kw: 'incline',             credits: [['cat-chest', 1.0], ['cat-shoulders', 0.2], ['cat-triceps', 0.15]] },
  { kw: 'decline',             credits: [['cat-chest', 1.0], ['cat-triceps', 0.15]] },
  { kw: 'push-up',             credits: [['cat-chest', 1.0], ['cat-triceps', 0.2], ['cat-shoulders', 0.1]] },
  { kw: 'pushup',              credits: [['cat-chest', 1.0], ['cat-triceps', 0.2], ['cat-shoulders', 0.1]] },
  { kw: 'dip',                 credits: [['cat-chest', 1.0], ['cat-triceps', 0.25], ['cat-shoulders', 0.1]] },
  { kw: 'fly',                 credits: [['cat-chest', 1.0]] },
  { kw: 'crossover',           credits: [['cat-chest', 1.0]] },

  // Back
  { kw: 'deadlift',            credits: [['cat-back', 1.0], ['cat-legs', 0.25]] },
  { kw: 'pull-up',             credits: [['cat-back', 1.0], ['cat-biceps', 0.25]] },
  { kw: 'pullup',              credits: [['cat-back', 1.0], ['cat-biceps', 0.25]] },
  { kw: 'chin-up',             credits: [['cat-back', 1.0], ['cat-biceps', 0.25]] },
  { kw: 'chinup',              credits: [['cat-back', 1.0], ['cat-biceps', 0.25]] },
  { kw: 'lat pulldown',        credits: [['cat-back', 1.0], ['cat-biceps', 0.2]] },
  { kw: 'pulldown',            credits: [['cat-back', 1.0], ['cat-biceps', 0.2]] },
  { kw: 'row',                 credits: [['cat-back', 1.0], ['cat-biceps', 0.2]] },
  { kw: 'shrug',               credits: [['cat-back', 1.0]] },

  // Legs
  { kw: 'romanian',            credits: [['cat-legs', 1.0], ['cat-back', 0.15]] },
  { kw: 'rdl',                 credits: [['cat-legs', 1.0], ['cat-back', 0.15]] },
  ...
  { kw: 'plank',               credits: [['cat-core', 1.0], ['cat-abs', 0.25]] },
...
export const STATUS_LABEL: Record<VolumeStatus, string> = {
  ...
  productive: 'Productive Volume',
  progressive: 'Hypertrophy Zone',
  high: 'High Volume - Hypertrophy Zone',
  very_high: 'Overreach Zone',
};
