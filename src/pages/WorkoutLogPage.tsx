            ...
            <div key={we.id} className="gym-card">
              ...
              {isExpanded && (
                <div className="space-y-2 animate-slide-up">
                  ...
                  />
                  {/* Dynamic Headers */}
                  <div className="grid gap-1 text-[10px] uppercase text-muted-foreground font-medium px-1" style={{ gridTemplateColumns: '1.2rem 1rem 1.8rem 0.5rem minmax(3rem,1.5fr) minmax(3rem,1.5fr) minmax(2.5rem,1fr) 1.8rem 1rem' }}>
                    <div>Set</div>
                    <div></div>
                    <div>Type</div>
                    <div></div>
                  ...
                  {sets.map(s => {
                    ...
                    return (
                    <div key={s.id}>
                      <div className={`grid gap-1 items-center px-1 py-1 rounded-lg transition-colors ${s.isCompleted ? 'bg-primary/10' : ''}`} style={{ gridTemplateColumns: '1.2rem 1rem 1.8rem 0.5rem minmax(3rem,1.5fr) minmax(3rem,1.5fr) minmax(2.5rem,1fr) 1.8rem 1rem' }}>
